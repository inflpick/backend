...
class CustomAuthenticationToken extends AbstractAuthenticationToken {
    ...
    public static Authentication authenticated(Object principal, Object credentials, Collection<? extends GrantedAuthority> authorities) {
        return new CustomAuthenticationToken(principal, credentials, authorities);
    }

    public static Authentication notAuthenticated(Object principal, Object credentials) {
