package com.leesh.inflpick.v2.common.adapter.out.storage.aws;
...
@Profile("prod")
@Service
public class AwsS3Port implements StoragePort {

    private final S3Client s3Client;
    private final StorageProperties storageProperties;
    private final AwsProperties awsProperties;

    public AwsS3Port(S3Client s3Client, AwsProperties awsProperties, StorageProperties storageProperties) {
