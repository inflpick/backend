...
public interface InfluencerWebRequestDocs {
    ...
    @ArraySchema(arraySchema = @Schema(description = "인플루언서의 소셜 미디어 프로필 링크 목록 (기본값: 빈 배열)", implementation = SocialMediaProfileRequestDocs.class, requiredMode = Schema.RequiredMode.NOT_REQUIRED))
