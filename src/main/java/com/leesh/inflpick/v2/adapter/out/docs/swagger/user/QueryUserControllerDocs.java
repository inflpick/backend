package com.leesh.inflpick.v2.adapter.out.docs.swagger.user;
...
public interface QueryUserControllerDocs {
    ...
    ResponseEntity<WebOffsetPageResponse<UserWebResponse>> query(@RequestParam(name = "page", required = false, defaultValue = "0")
                                                                 Integer page,
