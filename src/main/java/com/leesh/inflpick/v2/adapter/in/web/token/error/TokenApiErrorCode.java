...
public enum TokenApiErrorCode implements ApiErrorCode {
    ...
    EXPIRED_AUTHENTICATION_CODE("A0005", HttpStatus.BAD_REQUEST, "인증 요청이 만료됐어요.", "다시 로그인하거나, 문제가 반복될 경우 인플픽 관리자(info@inflpick.com)에게 문의 바랍니다.", "이미 토큰을 발급 받은 인증 코드로 다시 요청을 하는 경우 발생합니다."),
