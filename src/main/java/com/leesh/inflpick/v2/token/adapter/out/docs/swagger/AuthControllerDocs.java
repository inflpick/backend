...
public interface AuthControllerDocs {
    ...
    @Operation(summary = "인증 코드 받기",
        description = "해당 링크로 이동하여 소셜 로그인 진행 후 URL 파라미터를 통해 인증 코드를 받습니다. 인증 코드는 \"토큰 발급 API\"를 통해 액세스 토큰을 발급받을 때 사용됩니다.",
        parameters = {
            @Parameter(name = "provider", required = true, schema = @Schema(example = "GOOGLE", implementation = Oauth2Provider.class))
        },
        responses = {
            @ApiResponse(
                responseCode = "302",
