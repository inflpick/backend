...
public interface CreateTokenResponseDocs {
    @Schema(description = "토큰 타입 (Bearer로 고정)", example = "Bearer", implementation = String.class, requiredMode = Schema.RequiredMode.REQUIRED)
    String tokenType();
