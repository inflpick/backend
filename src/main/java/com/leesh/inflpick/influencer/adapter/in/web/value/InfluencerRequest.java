...
public record InfluencerRequest(
        ...
        @ArraySchema(arraySchema = @Schema(description = "인플루언서의 소셜 미디어 프로필 링크 목록", implementation = SocialMediaProfileRequest.class, requiredMode = Schema.RequiredMode.NOT_REQUIRED))
