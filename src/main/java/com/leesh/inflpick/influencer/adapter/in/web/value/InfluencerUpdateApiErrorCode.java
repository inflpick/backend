...
public enum InfluencerUpdateApiErrorCode implements ApiErrorCode {
    ...
    InfluencerUpdateApiErrorCode(String code, HttpStatus httpStatus, String reason, String action, String comment) {
        this.code = code;
