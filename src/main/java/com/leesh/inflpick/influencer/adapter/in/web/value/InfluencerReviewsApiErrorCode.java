...
public enum InfluencerReviewsApiErrorCode implements ApiErrorCode {
    ...
    REVIEW_URI_VALIDATION_FAILED("IN_V_0002", HttpStatus.BAD_REQUEST, "유효한 리뷰 URI를 입력해주세요.", ReviewContentsValidationFailedException.ERROR_MESSAGE_FORMAT.toPattern(), "리뷰 URI가 유효하지 않은 경우에 발생합니다.");
