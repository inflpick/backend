...
import com.leesh.inflpick.common.adapter.out.cors.CorsProperties;
import com.leesh.inflpick.token.adapter.out.token.jwt.vo.JwtProperties;
...
class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS)) // OAuth2UserService 사용 시, 유저 정보 저장을 위해 세션 사용
