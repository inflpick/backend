...
//    THIRD_PARTY_STORAGE_ERROR("C_O_0008", HttpStatus.INTERNAL_SERVER_ERROR, "파일 업로드에 실패하였습니다.", "잠시 후 다시 시도하거나, 인플픽 관리자에게 문의 바랍니다.", "파일 업로드 시, 외부 서비스의 오류로 인하여 파일이 업로드 되지 않은 경우에 발생합니다."),
//    INVALID_FILE("C_O_0009", HttpStatus.BAD_REQUEST, "업로드 한 파일이 유효하지 못해 서버에서 파일 업로드를 거부하였습니다.", "업로드한 파일을 확인 후 다시 요청해주세요.", "파일 형식이나 내용에 문제가 있거나 파일 이름이 없어서 서버에서 업로드를 거부한 경우에 발생합니다."),
    ;
