...
public record ApiErrorResponse(
        ...
        String code,
        @Schema(description = "에러 원인", example = "입력값이 유효하지 않습니다.", implementation = String.class, requiredMode = Schema.RequiredMode.REQUIRED)
        String reason,
        @Schema(description = "에러 해결을 위한 조치 사항", example = "인플루언서 이름은 최소 1글자, 최대 300글자 이하여야 합니다.", implementation = String.class, requiredMode = Schema.RequiredMode.REQUIRED)
        String action,
